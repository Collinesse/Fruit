    ...
    <div class="col-lg-6">
      ...
      <div class="card mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">Enregistrez une categorie</h6>
        </div>
        <div class="card-body">
          <form method="POST" action="{{ route('categorie.store') }}">
            @csrf
            <div class="form-group">
              <label for="origine">Origine du fruit</label>
              <input class="form-control" name="origine" id="origine" aria-describedby="emailHelp"
